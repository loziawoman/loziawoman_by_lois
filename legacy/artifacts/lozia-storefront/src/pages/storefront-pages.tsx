  ...
  return <div>
    ...
    <section className="relative min-h-[calc(100dvh-74px)] overflow-hidden bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))]">
      ...
      <div className="absolute right-[-18%] top-[8%] h-[86vw] max-h-[680px] w-[86vw] max-w-[680px] overflow-hidden rounded-full border border-[hsl(var(--secondary))]/35 shadow-2xl md:right-[5%] md:top-[9%]">
        <img src="/images/lozia-logo.jpeg" alt="LOZIA logo" className="h-full w-full object-cover" />
    ...
    <section className="mx-auto grid max-w-[1440px] gap-4 px-5 pb-20 md:grid-cols-3 md:px-10">
      <Link href="/shop?category=Tailoring" className="group relative min-h-[360px] overflow-hidden bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))]">
        <img src="/images/lozia-blazer.jpg" alt="Tailoring — The Corporate Edit" className="image-hover absolute inset-0 h-full w-full object-cover opacity-45" />
      ...
      <Link href="/shop?category=Sets" className="group relative min-h-[360px] overflow-hidden bg-[hsl(var(--accent))] text-[hsl(var(--primary))]">
        <img src="/images/atelier-set.jpg" alt="Everyday — Pieces with presence" className="image-hover absolute inset-0 h-full w-full object-cover opacity-55" />
        <div className="relative flex h-full min-h-[360px] flex-col justify-end p-7">
      ...
      <Link href="/shop?category=Dresses" className="group relative min-h-[360px] overflow-hidden bg-[hsl(var(--muted))]">
        <img src="/images/muse-dress.jpg" alt="Evening — After hours" className="image-hover absolute inset-0 h-full w-full object-cover" />
    ...
    <section className="grid min-h-[650px] md:grid-cols-2">
      ...
      <div className="relative min-h-[500px] overflow-hidden bg-[hsl(var(--muted))]">
        <img src="/images/atelier-set.jpg" alt="The Atelier Set editorial" className="h-full w-full object-cover image-hover" />
      </div>
    </section>
    ...
    <section className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-28">
      ...
      <div className="mt-10 grid grid-cols-2 gap-3 md:grid-cols-4">
        {products.slice(0,4).map((p) => <img key={p.id} src={p.images[0]} alt={`${p.name} on Instagram`} className="aspect-square w-full object-cover image-hover" />)}
      </div>
    </section>
  </div>;
}
...
export function ProductPage({ slug }: { slug?: string }) {
  ...
  const bag=useBag();
  const requestedColour=typeof window !== 'undefined' ? new URLSearchParams(window.location.search).get('colour') : null;
  const initialColour=product?.colours.find((item)=>item.name.toLowerCase()===requestedColour?.toLowerCase())?.name || product?.colours[0].name || '';
  ...
  return <main>
    <section className="bg-[hsl(var(--primary))] px-5 py-16 text-[hsl(var(--primary-foreground))] md:px-16 md:py-24">
      <div className="mx-auto grid max-w-[1280px] gap-10 md:grid-cols-[.9fr_1.1fr] md:items-center md:gap-20">
        ...
        <div className="relative aspect-[4/5] overflow-hidden rounded-[2px] bg-[hsl(var(--muted))]">
          <img src="/images/lozia-about-hero.png" alt="LOZIA woman in a dark tailored suit" className="h-full w-full object-cover object-top" />
    ...
    <section className="mx-auto max-w-[1100px] px-5 py-20 md:grid md:grid-cols-[.8fr_1.2fr] md:gap-28 md:py-32">
      <span className="mono text-[hsl(var(--accent))]">Our point of view
        <img src="/images/muse-dress.jpg" alt="Muse dress" className="h-full w-full object-cover object-top" />
      </span>
      <div>
    ...
    <section className="grid md:grid-cols-2">
      <img src="/images/lozia-blazer.jpg" alt="LOZIA studio tailoring" className="h-[600px] w-full object-cover" />
...
export function CheckoutPage() {
  ...
  if(submitted)return <main className="mx-auto max-w-[700px] px-5 py-28 text-center">
      ...
      <div className="grid gap-14 md:grid-cols-[1.1fr_.9fr]">
        <form onSubmit={submit} className="space-y-9">
          ...
          <fieldset>
            ...
            <div className="mt-5 border border-[hsl(var(--accent))] bg-[hsl(var(--accent))]/10 p-5">
              ...
              <div className="mt-4 border-t border-[hsl(var(--accent))]/30 pt-4 text-sm"><p>LOZIA Studio Ltd</p><p>GTBank · 0123456789</p></div>
            </div>
          </fieldset>
        ...
        <div className="h-fit bg-[hsl(var(--muted))] p-6 md:p-8">
          ...
          {bag.items.map(i=><div className="mt-5 flex gap-4 border-b border-[hsl(var(--border))] pb-4" key={i.variantId}>
            <img src={i.image} className="h-24 w-18 object-cover" alt={i.productName}/>
          ...
          <button onClick={()=>setLocation('/shop')} className="mt-5 text-xs underline" data-testid="button-continue-shopping">Continue shopping</button>
        </div>
      </div>
    )}
  </main>;
