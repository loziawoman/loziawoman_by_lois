...
export function Header({ bag }: { bag: ReturnType<typeof useBag> }) {
...
export function BagDrawer({ bag }: { bag: ReturnType<typeof useBag> }) {
  return <>
